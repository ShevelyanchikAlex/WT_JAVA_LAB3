package com.bsuir.alex.archive.server.dao.impl;

import com.bsuir.alex.archive.server.bean.Student;
import com.bsuir.alex.archive.server.dao.DaoException;
import com.bsuir.alex.archive.server.dao.UniversityDao;
import com.bsuir.alex.archive.server.dao.parser.XMLParser;
import com.bsuir.alex.archive.server.dao.parser.XMLParserException;
import com.bsuir.alex.archive.server.dao.parser.impl.XMLUniversityParser;
import com.bsuir.alex.archive.server.dao.writer.Writer;
import com.bsuir.alex.archive.server.dao.writer.XMLWriterException;
import com.bsuir.alex.archive.server.dao.writer.impl.WriterImpl;
